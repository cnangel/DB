...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::Base=>q[0.50], Filter::Util::Call=>q[0], ExtUtils::MakeMaker=>q[6.42], DBI=>q[1.6] }
#     VERSION => q[0.002]
#     dist => {  }
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,002,0,0">' > $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="DBI" VERSION="1,6,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Test-Base" VERSION="0,50,0,0" />' >> $(DISTNAME).ppd
